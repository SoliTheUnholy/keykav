...
export default function FirstStep(
  { setStep }: { setStep: (step: number) => void }
) {
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      <p className="w-xl max-w-[90vw] text-center text-foreground text-pretty">
      ...
      >
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-background px-5 py-0.5 text-sm font-medium text-foreground backdrop-blur-3xl hover:opacity-95">
          اولین قدم رو بردار !
        </span>
      </button>
    </div>
